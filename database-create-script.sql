...
create table recipe (cook_time integer, prep_time integer, servings integer, id bigint not null auto_increment, notes_id bigint, description varchar(255), source varchar(255), url varchar(255), difficulty enum ('EASY','HARD','KIND_OF_HARD','MODERATE'), directions tinytext, image tinyblob, primary key (id)) engine=InnoDB;
...
alter table notes add constraint UKgyihyf17jnihru8eoym1tmucb unique (recipe_id);
alter table recipe add constraint UK61xwuqykaisawug77hnwnhg3i unique (notes_id);
